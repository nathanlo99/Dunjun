...
inline Matrix4f Matrix4f::operator+(const Matrix4f& other) const {
...
inline Matrix4f Matrix4f::operator*(float s) const {
...
inline bool Matrix4f::operator==(const Matrix4f& other) {
