...
OBJECTS = bin/main.o bin/Dunjun/ShaderProgram.o bin/Dunjun/Texture.o bin/Dunjun/Image.o bin/Dunjun/Math/Vector2f.o bin/Dunjun/Math/Vector3f.o bin/Dunjun/Math/Vector4f.o bin/Dunjun/Math/Matrix4f.o
